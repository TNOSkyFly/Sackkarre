...
float read_battery_voltage() {
    ...
    // Schwelle erhöht: Wenn der ADC weniger als ~0.3V misst (ca. 350-400 RAW), 
    // ist kein Akku angeschlossen -> Zeige glatt 0.0V an
    if (rawADC < 400) return 0.0; 
...
void setup() {
    ...
    // Endpunkt für das Web-App Manifest
    server.on("/manifest.json", [](){
        String json = "{"
          ...
          "\"theme_color\":\"#000000\","
          "\"icons\":[{"
            "\"src\":\"data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAGAAAABgCAYAAADimH4VAAAAAXNSR0IArs4c6QAAAARnQU1BAACxjwv8YQUAAAAJcEhZcwAADsMAAA7DAcdvqGQAAAA0SURBVHhe3cExAQAAAMKg9U9tCj8gAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAD4AN28AAXB3A28AAAAASUVORK5CYII=\","
            "\"sizes\":\"96x96\","
            "\"type\":\"image/png\""
          "}]"
        "}";
